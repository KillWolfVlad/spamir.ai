...
test_cases = [
    ...
    (
        "replace one phone",
        "Ты убедишься во всем далее   +79956532434",
        "ты убедишься во всем далее [PHONE]",
    ),
    (
        "replace two phones",
        "Ты убедишься во всем далее   +79956532434 или   +79318075751",
        "ты убедишься во всем далее [PHONE] или [PHONE]",
    ),
    (
        "trim",
